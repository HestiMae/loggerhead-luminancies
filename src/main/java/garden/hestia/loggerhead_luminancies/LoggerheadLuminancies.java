...
public class LoggerheadLuminancies implements ModInitializer {
    ...
    public static final Block SCUTE_LANTERN = Registry.register(Registries.BLOCK, LoggerheadLuminancies.id("scute_lantern"), new ScuteLanternBlock(FabricBlockSettings.copyOf(Blocks.SEA_LANTERN)));
